...
My CMake Project (dir) **utility** is under dir(C++):

![folder(utility)](images/utilityDir.png)

You need both **CMakeLists.txt** and **CMakePresets.json**.

Under dir(utility), there are two sub-projects (sub-dirs), unitTest and zutility (static-lib). **unitTest** is shown below:

![folder(unitTest)](images/unitTestDir.png)

You need the **CMakeLists.txt** in both unitTest and zutility.
